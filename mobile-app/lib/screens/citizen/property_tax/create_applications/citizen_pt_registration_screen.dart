...
class CitizenPtRegistrationScreen extends StatefulWidget {
  const CitizenPtRegistrationScreen({super.key});

  @override
  State<CitizenPtRegistrationScreen> createState() => _CitizenPtRegistrationScreenState();
}

class _CitizenPtRegistrationScreenState extends State<CitizenPtRegistrationScreen> {
